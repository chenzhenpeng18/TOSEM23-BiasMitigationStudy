...
val_name = "lfr_{}_{}_{}.txt".format(clf_name,dataset_used,attr)
...
for r in range(repeat_time):
    ...
    clf.fit(dataset_transf_train.features, dataset_orig_train.labels, epochs=20)
    pred = clf.predict_classes(dataset_transf_test.features).reshape(-1,1)
