...
val_name = "dir_{}_{}_{}.txt".format(clf_name,dataset_used,attr)
...
for r in range(repeat_time):
    ...
    clf = get_classifier(clf_name,(train_repd.features.shape[1:][0]-1,))
    clf.fit(X_tr, y_tr, epochs=20)

    test_repd_pred = test_repd.copy()
    test_repd_pred.labels = clf.predict_classes(X_te)
