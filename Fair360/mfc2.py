...
val_name = "mfc2_{}_{}_{}.txt".format(clf_name,dataset_used,attr)
...
for r in range(repeat_time):
    ...
    # type = ["fdr", "sr"]
    metafair = MetaFairClassifier(sensitive_attr=attr, type="sr").fit(dataset_orig_train)

    pred_metafair = metafair.predict(dataset_orig_test)

    round_result = measure_final_score(dataset_orig_test, pred_metafair, privileged_groups, unprivileged_groups)
