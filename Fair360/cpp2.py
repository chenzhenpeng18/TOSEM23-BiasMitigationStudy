...
val_name = "cpp2_{}_{}_{}.txt".format(clf_name, dataset_used, attr)
...
randseed = 12345679
results = {}
performance_index = ['accuracy', 'recall1', 'recall0', 'recall_macro', 'precision1', 'precision0', 'precision_macro',
                     'f1score1', 'f1score0', 'f1score_macro', 'roc_auc', 'mcc', 'spd', 'di', 'aod', 'eod', 'erd']
...
for r in range(repeat_time):
    ...
    round_result = measure_final_score(dataset_orig_test, pred_cpp, privileged_groups, unprivileged_groups)
