...
val_name = "eqo_{}_{}_{}.txt".format(clf_name,dataset_used,attr)
...
for r in range(repeat_time):
    ...
    round_result = measure_final_score(dataset_orig_test, pred_eqo, privileged_groups, unprivileged_groups)
